...
public  class SyncedMapFragment extends SupportMapFragment {
    ...
    public void animateMarkerToGB(Marker marker, Double latitude,Double longitude, LatLngInterpolator latLngInterpolator,
                                  long duration) {

        LatLng finalPosition=new LatLng(latitude,longitude);
        if (mWrapper == null) {
