 ...
 * It is Derived class from Roman guy's Rounded Corner Images and m3n0r's
 * Rounded Drawable
 *
 * @author siddhesh
 * @version 1.1
 ...
 * @see <a href =
 * "https://github.com/m3n0R/MenorImageView/blob/22b2af96f72cabddecc4a0612fbd90d4504a200f/MenorImageView/src/com/android/menorimageview/RoundedDrawable.java"
 * >RoundedDrawable<a/>
 */
public class StreamDrawable extends Drawable {
    ...
    StreamDrawable(Bitmap bitmap, float cornerRadius, int margin,
                   boolean isVignette, ScaleType scaleType) {
        if (scaleType == null)
     ...
     *
     * @see
     * android.graphics.drawable.Drawable#onBoundsChange(android.graphics.
     * Rect)
     */
    @Override
    protected void onBoundsChange(Rect bounds) {
        ...
        mDrawableRect.set(0 + mMargin, 0 + mMargin, mBorderRect.width()
                - mMargin, mBorderRect.height() - mMargin);
        float scale;
        float dx;
        float dy;
        switch (mScaleType) {
            case FIT_CENTER:
                ...
                mDrawableRect.set(mBorderRect.left + mMargin,
                        mBorderRect.top + mMargin, mBorderRect.right
                                - mMargin, mBorderRect.bottom - mMargin);
            ...
            case CENTER:
                ...
                mDrawableRect.set(0 + mMargin, 0 + mMargin,
                        mBorderRect.width() - mMargin, mBorderRect.height()
                                - mMargin);
            ...
            case CENTER_CROP:
                ...
                dx = 0;
                dy = 0;
                if (mBitmapWidth * mDrawableRect.height() > mDrawableRect
                        .width() * mBitmapHeight) {
            ...
            default:
                mDrawableRect.set(mMargin, mMargin, bounds.width()
                        - mMargin, bounds.height() - mMargin);
                break;
        }
        ...
        if (isVignette) {
            RadialGradient vignette = new RadialGradient(
                    ...
                    mDrawableRect.centerY() * 1.0f / 0.7f,
                    mDrawableRect.centerX() * 1.9f, new int[]{0, 0,
                    0x7f000000}, new float[]{0.0f, 0.7f, 1.0f},
                    Shader.TileMode.CLAMP);
