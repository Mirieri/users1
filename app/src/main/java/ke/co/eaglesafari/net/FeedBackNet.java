...
public class FeedBackNet extends AsyncTask<String, String,ResponseModel>
{
	Context context;
	...
	public FeedBackNet(FeedBackItem feedBackItem ,Context context, I_Response<Boolean,String> booleanI_response)
	{
	...
	protected ResponseModel doInBackground(String... params)
	{
		...
		if(can_connect)
		{
			...
			rep = usf.send_feedback(feedBackItem);
		}
		return rep;
	}
	@Override
